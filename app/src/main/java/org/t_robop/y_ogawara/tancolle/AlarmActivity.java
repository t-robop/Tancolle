...
//    public void alarm(String name, int year, int month,int day,int birthmonth,int birthday,int Mnotif,int Wnotif,int Ynotif,int Tnotif,int custum1,int custum2,int custum3){
//        Calendar calendar;
//        int intentId;
//
//        int cat,dog; //月日を４桁にするやつ（現在の日付と誕生日）
...
//
//
//            //alarm(name,year,month,day,birthmonth,birthday,Mnotif,Wnotif,Ynotif,Tnotif,custum1,custum2,custum3);
//
//        }
//    }
//    public void alarm(String name, int year, int month,int day,int birthmonth,int birthday,int Mnotif,int Wnotif,int Ynotif,int Tnotif,int custum1,int custum2,int custum3){
...
//            //monthText = (name) + "さんの誕生日まで残り１ヶ月です";
//            //設定した日時で発行するIntentを生成
//            Intent alarmMonth = new Intent(this, Notifier.class);
//            alarmMonth.putExtra("intentId",1);
//            alarmMonth.putExtra("intentString",(name) + "さんの誕生日まで残り１ヶ月です");
//            PendingIntent sender = PendingIntent.getBroadcast(AlarmActivity.this, 0, alarmMonth, PendingIntent.FLAG_UPDATE_CURRENT);
//
